<div>
    <div class="page-header">
        <div class="page-header-text">
            <h1 class="page-title">Input Setoran</h1>
            <p class="page-subtitle">Catat setoran hafalan santri hari ini.</p>
        </div>
    ...
    <form wire:submit="save">
            ...
            <div class="card-body">
                <div class="form-row form-row-2">
                    ...
                    <div class="form-group">
                        <label class="form-label">Ustadz Penerima</label>
                        <input type="text" value="{{ auth()->user()->name }}" disabled class="form-input">
                        <p class="form-hint">Otomatis tercatat sebagai ustadz yang sedang login.</p>
                    </div>
                </div>
        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                    ...
                    <div class="form-row form-row-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="6" wire:model="iqro_awal"
                                class="form-input @error('iqro_awal') error @enderror" placeholder="1">
                            @error('iqro_awal')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="halaman_iqro_awal"
                                class="form-input @error('halaman_iqro_awal') error @enderror" placeholder="1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="ayat_iqro_awal"
                                class="form-input @error('ayat_iqro_awal') error @enderror" placeholder="1">
                    ...
                    <div class="form-row form-row-3">
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="6" wire:model="iqro_akhir"
                                class="form-input @error('iqro_akhir') error @enderror" placeholder="1">
                            @error('iqro_akhir')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="halaman_iqro_akhir"
                                class="form-input @error('halaman_iqro_akhir') error @enderror" placeholder="2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="ayat_iqro_akhir"
                                class="form-input @error('ayat_iqro_akhir') error @enderror" placeholder="2">
                ...
                @if ($tingkatan === 'juz_ama')
                    ...
                    <p class="form-hint mb-3">Bisa satu surat atau lintas surat (misal: An-Naba' s.d. An-Nazi'at).</p>
                    ...
                    <div class="form-row form-row-2">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="surah_awal"
                                class="form-input @error('surah_awal') error @enderror" placeholder="An-Naba">
                            @error('surah_awal')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="ayat_awal"
                                class="form-input @error('ayat_awal') error @enderror" placeholder="1">
                            @error('ayat_awal')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row form-row-2">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="surah_akhir"
                                class="form-input @error('surah_akhir') error @enderror" placeholder="An-Nazi'at">
                            @error('surah_akhir')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="ayat_akhir"
                                class="form-input @error('ayat_akhir') error @enderror" placeholder="46">
                            @error('ayat_akhir')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row form-row-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="halaman_awal"
                                class="form-input @error('halaman_awal') error @enderror" placeholder="82">
                            @error('halaman_awal')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" min="1" wire:model="halaman_akhir"
                                class="form-input @error('halaman_akhir') error @enderror" placeholder="84">
                            @error('halaman_akhir')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                <div class="form-row form-row-2">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1" min="0.1" wire:model="jumlah_halaman"
                            class="form-input @error('jumlah_halaman') error @enderror" placeholder="1.5">
                ...
                <div class="form-group mt-4">
                    ...
                    <textarea wire:model="catatan" rows="3" class="form-textarea"
                        placeholder="Contoh: Bacaan sudah lancar, perbaiki tajwid di ayat ke-5..."></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap justify-end gap-2">
            ...
            <button type="submit" wire:loading.attr="disabled" wire:target="save" class="btn btn-primary btn-md"
                wire:loading.class="loading" wire:target="save">
                Simpan Setoran
            </button>
        </div>
    </form>
